...
<div style="display: flex; flex-direction: column; align-items: center;">
  ...
  <div style="display: flex; gap: 30px; justify-content: center; align-items: stretch;">
    <img src="888.jpg" alt="Hafez Poetry" style="width:300px; height:300px; object-fit: cover;">
    <img src="8888.jpg" alt="Hafez Poetry" style="width:300px; height:300px; object-fit: cover;">
  </div>

  <div style="max-width: 630px; text-align: justify; margin-top: 20px;">
